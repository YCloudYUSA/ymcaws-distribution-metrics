 ...
 *
 * Extended for YMCA Website Services distribution (openy_*, y_*, ws_*, lb_*).
 */
const HOOK_IMPLEMENTATION_PATTERNS = [
    ...
    // YMCA Website Services distribution patterns
    '/^openy_[a-z0-9_]+$/',                                       // openy_* hooks
    '/^y_[a-z0-9_]+$/',                                           // y_* hooks
    '/^ws_[a-z0-9_]+$/',                                          // ws_* hooks
    '/^lb_[a-z0-9_]+$/',                                          // lb_* hooks
];
